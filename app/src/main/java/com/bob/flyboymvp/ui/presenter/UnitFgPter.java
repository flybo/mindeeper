...
import com.bob.flyboymvp.ui.adapter.SortAdapter;
...
public class UnitFgPter extends BasePresenter<IUnitFgView> {
    ...
    public void initData(){
        try {
            ...
            mAdapter = new SortAdapter(mContext, listData);
